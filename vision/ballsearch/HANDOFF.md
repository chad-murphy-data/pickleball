...
0. **Path-first is the incumbent** (section above; adopted 2026-09-01
   ...
   stay bit-identical, events bar as written. Clean seal = r20/r21
   (label_picks.md); r9/r10 are spent for this line too. The fill
   may be used for the 3D viewer / demo cuts as TAGGED inference
   (dashed, captioned) without a gate — it never enters a grade. Meanwhile: `label_picks.md` (r17
