...
**Consequence for the 35-bounce panel:** the "human bounces" it grades
against are fitter calls on the owner's path, and those undercount by
the at-feet class (~13%). The panel is a ceiling on what the FITTER
can see, not on what happened. A boundary-typing rule (to-do (a))
graded on the taps instead of on the fitter now has real truth; the
