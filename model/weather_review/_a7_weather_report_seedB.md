...
WLS slope: per +10 mph: +0.0017 (95% cluster-bootstrap CI [-0.0027, +0.0059])
...
WLS slope: per +10 mph: +0.0030 (95% cluster-bootstrap CI [-0.0009, +0.0070])
...
| 8–14 mph | 13212 | 0.814 | 0.774 | -0.040 [-0.048,-0.031] | 0.1581 |
| 14–20 mph | 3834 | 0.815 | 0.769 | -0.046 [-0.059,-0.032] | 0.1598 |
...
| 82–92 °F | 6668 | 0.814 | 0.779 | -0.036 [-0.048,-0.024] | 0.1538 |
| 92+ °F | 1755 | 0.811 | 0.756 | -0.055 [-0.075,-0.038] | 0.1700 |

### B2. Favorites vs wind AT MATCH HOUR (24819 games)
| wind_h | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
| 0–8 mph | 17139 | 0.814 | 0.773 | -0.040 [-0.047,-0.033] | 0.1572 |
...
| 70–82 °F | 11241 | 0.813 | 0.771 | -0.041 [-0.050,-0.034] | 0.1585 |
| 82–92 °F | 3311 | 0.811 | 0.767 | -0.044 [-0.058,-0.029] | 0.1609 |
| 92+ °F | 644 | 0.813 | 0.764 | -0.049 [-0.084,-0.029] | 0.1662 |
...
WLS slope: per +10 mph: +0.0005 (95% cluster-bootstrap CI [-0.0053, +0.0060])
...
WLS slope: per +10 mph: +0.0018 (95% cluster-bootstrap CI [-0.0028, +0.0066])

### B. Favorites vs wind (daily max) (11699 games)
| wind | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
| 0–8 mph | 2827 | 0.818 | 0.773 | -0.045 [-0.065,-0.026] | 0.1544 |
| 8–14 mph | 6921 | 0.815 | 0.773 | -0.042 [-0.053,-0.032] | 0.1579 |
| 14–20 mph | 1617 | 0.806 | 0.774 | -0.032 [-0.065,-0.001] | 0.1604 |
| 20+ mph | 334 | 0.803 | 0.716 | -0.088 [-0.147,-0.048] | 0.1830 |

### C. Favorites vs heat (daily max) (11699 games)
| tmax | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
| 0–70 °F | 2757 | 0.817 | 0.776 | -0.041 [-0.060,-0.020] | 0.1551 |
| 70–82 °F | 4908 | 0.814 | 0.769 | -0.046 [-0.064,-0.029] | 0.1599 |
| 82–92 °F | 2770 | 0.807 | 0.764 | -0.043 [-0.059,-0.027] | 0.1616 |
| 92+ °F | 1226 | 0.823 | 0.789 | -0.035 [-0.055,-0.014] | 0.1499 |

### B2. Favorites vs wind AT MATCH HOUR (11699 games)
| wind_h | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
| 0–8 mph | 6847 | 0.817 | 0.778 | -0.040 [-0.051,-0.027] | 0.1538 |
| 8–14 mph | 4062 | 0.810 | 0.768 | -0.042 [-0.060,-0.027] | 0.1614 |
...
| temp_h | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
| 0–70 °F | 3749 | 0.820 | 0.778 | -0.042 [-0.057,-0.026] | 0.1530 |
| 70–82 °F | 5380 | 0.812 | 0.767 | -0.045 [-0.060,-0.031] | 0.1600 |
| 82–92 °F | 1894 | 0.807 | 0.758 | -0.049 [-0.070,-0.028] | 0.1659 |
