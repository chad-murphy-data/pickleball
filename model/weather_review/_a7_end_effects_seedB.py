...
def boot(clustered, stat, n=4000, seed=911):
    keys = list(clustered)
...
def main():
    ...
    (ROOT / "model/weather_review/_a7_end_effects_seedB.md").write_text("\n".join(out) + "\n")
