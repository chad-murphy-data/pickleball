...
WLS slope: +0.171 pp serve-rate per 1000×mph → per +10 mph: +0.0017 (95% cluster-bootstrap CI [-0.0024, +0.0061])

### B. Favorites vs wind (24909 games)
...
### C. Favorites vs heat (24909 games)
...
## INDOOR  *(placebo arm — nothing should move)*
...
WLS slope: +0.045 pp serve-rate per 1000×mph → per +10 mph: +0.0005 (95% cluster-bootstrap CI [-0.0052, +0.0059])

### B. Favorites vs wind (11699 games)
| wind | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
...
### C. Favorites vs heat (11699 games)
| tmax | games | predicted fav % | observed fav % | edge (obs−pred) | Brier |
|---|---|---|---|---|---|
